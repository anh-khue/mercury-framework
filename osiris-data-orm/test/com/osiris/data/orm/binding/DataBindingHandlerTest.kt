...
internal class DataBindingHandlerTest {
    ...
    fun fetchColumns() {
        ...
        val result: List<String> = com.osiris.data.orm.handler.fetchColumns(Drink::class.java)
    ...
    fun fetchFields() {
        ...
        val result: List<String> = com.osiris.data.orm.handler.fetchFields(Drink::class.java)
                .map { it.name }
                .toList()
        result.forEach({ println(it) })
